...
const AddRecordScreen = ({route, navigation}) => {
    ...
    const addRecord = async () => {
        // console.log("type " + typeValue + "  reading " + reading)


        await fetch('https://patient23-b67195267fc1.herokuapp.com/patients/' + patient._id + '/tests', {
            method: 'POST',
            headers: {
            ...
            .then((json) => {
                ...
                Alert.alert("Message", "Record Created Successfully ", [
            ...
            <View style={{flex: 1}}>
                ...
                <KeyboardAvoidingView
                    ...
                    <View style={styles.containerInput}>
                        <TextInput style={styles.input} placeholder="Reading"
